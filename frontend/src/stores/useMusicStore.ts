...
export const useMusicStore = create<MusicStore>((set) => ({
	...
	fetchAlbums: async () => {
		...
		try {
			...
			console.error("fetchAlbums error:", errorMsg);
			set({ error: errorMsg });
		} finally {
			set({ isLoading: false });
		}
	...
	fetchAlbumById: async (id) => {
		...
		try {
			...
			console.error("fetchAlbumById error:", errorMsg);
			set({ error: errorMsg });
		} finally {
			set({ isLoading: false });
		}
	...
	fetchFeaturedSongs: async () => {
		...
		try {
			...
			console.error("fetchFeaturedSongs error:", errorMsg);
			set({ error: errorMsg });
		} finally {
			set({ isLoading: false });
		}
	...
	fetchMadeForYouSongs: async () => {
		...
		try {
			...
			console.error("fetchMadeForYouSongs error:", errorMsg);
			set({ error: errorMsg });
		} finally {
			set({ isLoading: false });
		}
	...
	fetchTrendingSongs: async () => {
		...
		try {
			...
			console.error("fetchTrendingSongs error:", errorMsg);
			set({ error: errorMsg });
		} finally {
			set({ isLoading: false });
		}
